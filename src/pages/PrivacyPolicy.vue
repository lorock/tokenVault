<template>
  <div class="legal-page">
    <van-nav-bar :title="t('legal.privacyTitle')" left-arrow :border="false" @click-left="goHome" />

    <Breadcrumb :label="t('legal.privacyTitle')" />
...
const content = computed(() => privacy[locale.value] || privacy.zh)
