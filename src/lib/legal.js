...
export const privacy = {
  zh: [
    ...
    },
    {
      heading: '七、联系我们',
      paragraphs: [
        '本工具官方网站为 k.sre.wang（唯一官方站点，已ICP备案）。如对本隐私政策有疑问，可通过项目仓库 Issue 与我们联系。'
      ]
    },
    {
      heading: '八、政策更新',
  ...
  en: [
    ...
    },
    {
      ...
      paragraphs: [
        'The official website of this tool is k.sre.wang (the only official site, with ICP filing in China). If you have any questions about this privacy policy, please reach out through the project repository Issues.'
      ]
    },
    {
...
export const disclaimer = {
  zh: [
    ...
    },
    {
      ...
      paragraphs: [
        '本工具为独立开源项目，<strong>非任何网站、平台或服务商的官方产品</strong>，与 GitHub、Google、AWS 等第三方无任何关联，也不代表其立场。本项目唯一官方站点为 k.sre.wang（已 ICP 备案），任何其它域名的页面均非本工具官方页面，请谨防仿冒。'
      ]
    },
    {
      heading: '四、使用范围',
